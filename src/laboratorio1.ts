// definir un tipo usuario que almenos contenga una propiedad activo
type TtipoUsuairo = 'Admin' | 'User' | 'Guest'
...
interface IUsuairo {
    ...
    apellidoP: string,
    password: string,
    tipoUsuario: TtipoUsuairo,
    activo: boolean
}

//crear un arreglo de usuario
const usersList: IUsuairo[] = [
    {
        id: '001',
        nombre: 'Daniel',
        apellidoP: 'Sanchez',
